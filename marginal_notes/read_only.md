...
#### Введение
Любой язык программирования, это прежде всего **язык**. В лингвистике определяют несколько функций языка[<sup>1</sup>](#1), главная из которых, при рассмотрении языков программирования, коммуникативная. 
