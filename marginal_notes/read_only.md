...
Если ваша библиотека использовалась где-то еще, любое изменение значение констант в вашей библиотеки, при ее обновлении, будут проигнорированы кодом клиента, если при обновлении не будет выполнена перекомпиляция этого кода[<sup>13</sup>](#13). Чтобы избежать такой ситуации, нужно воспользоваться 
