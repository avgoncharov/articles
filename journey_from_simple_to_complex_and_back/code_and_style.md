...
По настоящиму хорошая программа - это программа которая, при всех ограничениях и требованиях, имеет понятный исходный код. Для того чтобы научиться писать такие программы нужно много опыта. Но первым шагом на пути к хорошему коду, является разработка и/или применение стандарта оформления кода.
